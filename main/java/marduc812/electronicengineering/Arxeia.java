...
/**
 * Created by marduc on 10/20/14.
 */
public class Arxeia extends ActionBarActivity {


    String url = "http://www.el.teithe.gr/Files.aspx?View=List&Page=0&CID=0&SText=";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                Intent i = new Intent(getApplicationContext(), ArxeiaDisplay.class);
    ...
    private class MyTask extends AsyncTask<Void, Void, ArrayList<String>> {
        ...
        protected ArrayList<String> doInBackground(Void... params) {
            try {
                ...
                for (Element link : links)
                {
                    ...
                    if (AnnLink.contains("Files.aspx?View=Content&Page"))
                    {
                ...
                for (Element img : image)
                {
                    ...
                    if (imgSrc.contains("pin"))
                        ...
                        AnnounceImages.add(R.drawable.arxeiaattach);
                }
        ...
        protected void onPostExecute(ArrayList<String> result) {
            ...
            AnnounList adapter = new AnnounList(Arxeia.this, AnnounceTitles, AnnounceDesc, AnnounceImages);
