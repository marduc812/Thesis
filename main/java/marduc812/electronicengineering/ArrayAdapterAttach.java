 ...
 */
public class ArrayAdapterAttach extends ArrayAdapter<String> {
...
private final ArrayList<Integer> AnnouImage;
    ...
    public ArrayAdapterAttach(Activity context,
                              ArrayList<String> AnnounTitle, ArrayList<Integer> AnnouImage) {
        super(context, R.layout.attachlay, AnnounTitle);
...
public View getView(int position, View view, ViewGroup parent) {
        ...
        View rowView= inflater.inflate(R.layout.attachlay, null, true);
