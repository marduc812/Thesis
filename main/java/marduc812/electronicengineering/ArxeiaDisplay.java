 ...
 */
public class ArxeiaDisplay extends ActionBarActivity {
    ...
    private class MyTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            try {
                ...
                for (Element link : links)
                {
                    ...
                    if (AnnAtts.contains("File=FILES"))
                    {
                        AnnAtt.add(AnnAtts);
        ...
        protected void onPostExecute(Void result) {
            ...
            arrayAdapter = new ArrayAdapterAttach (ArxeiaDisplay.this, AnnAttTitle,images);
